          ...
          <div className="rounded-2xl p-8" style={{ background: 'var(--surface)', border: '1px solid var(--br)' }}>
            ...
            <div className="text-center mb-7">
              ...
              <p className="text-sm mt-1.5" style={{ color: 'var(--tx2)' }}>
                ...
                <Link to="/signup" className="font-semibold hover:underline" style={{ color: 'var(--accent)' }}>Sign up</Link>
              </p>
            </div>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-sm font-medium" style={{ color: 'var(--tx2)' }}>Password</label>
              ...
              <button type="submit" disabled={loading}
                ...
                {loading ? <span className="spin w-4 h-4 border-2 border-white/30 border-t-white rounded-full" /> : <LogIn size={15} />}
            ...
            <div className="my-5 flex items-center gap-3">
              ...
              <span className="text-xs font-medium" style={{ color: 'var(--tx3)' }}>or continue with</span>
              <div className="flex-1 h-px" style={{ background: 'var(--br2)' }} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button onClick={handleGoogle}
                      className="btn-ghost py-2.5 rounded-xl text-sm flex items-center justify-center gap-2">
            ...
            <button onClick={handleGuest}
                    className="mt-3 w-full py-2.5 rounded-xl text-sm flex items-center justify-center gap-2 transition-all"
